 ...
 *
 * Sends visitors to the in-app `/bookings` page so they land on the
 * embedded Cliniko scheduler experience rather than bouncing to the
 * raw Cliniko URL in a new tab.
 *
...
export function MobileBookingCta() {
  ...
  const href = locale ? `/${locale}/bookings` : "/bookings";
